...
/*       
Program Name            : PC-STM32F407 UART Ýletiþim
hardware                : STM32F4 Discovery kit
Compiler Version         : MikroC Pro for ARM 3.3.5
MCU Frequency            : 140Mhz.
...
int  i=0,j=0;
char gelen,rx_array[10],rx_array2[10];      // "gelen" isminde bir deðiþken ve "i" isminde bir sayaç tanýmlanýyor.
