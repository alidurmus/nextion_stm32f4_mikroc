#line 1 "B:/ELEKTRONÝK/deneme/two_interrupt_uart/uartx.c"
#line 9 "B:/ELEKTRONÝK/deneme/two_interrupt_uart/uartx.c"
int i=0,j=0;
...
while(1)
 {
#line 43 "B:/ELEKTRONÝK/deneme/two_interrupt_uart/uartx.c"
 if(i==6)
 {
 Delay_ms(200);
